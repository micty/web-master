    ...
    return exports = {
        ...
        */
        minify: function (options) {
            ...
            if (error) {
                ...
                console.error('已把压缩前的内容写入到  all.error.debug.js，请根据错误提示进行检查。');
            ...
            console.log('成功压缩 js 内容', size2.cyan, 'KB'.gray, ' 压缩率', percent.cyan + '%'.gray, ' 耗时', time.cyan, 'ms'.gray);
        ...
        */
        build: function (options) {
            ...
            var transform = options.transform || function () {};
            ...
            var content2 = transform(content, concat);
